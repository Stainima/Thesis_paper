...
does not appear on the right-hand side of any production rule.
...
This walkthorugh will follow very closely to the examples provided in the original paper \cite{kulkarniLearningHighlyRecursive2021}, and use a concrete example to provide an indepth explaination of ARVADA.
